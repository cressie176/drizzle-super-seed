...
`manifest.json` records the seed, reference date, row counts, trigger handling, table logging and generated files. Use it to reproduce the files or verify the row counts after loading.
