-- Pagila's schema, by Devrim Gunduz and contributors (PostgreSQL licence):
-- https://github.com/devrimgunduz/pagila
-- Two trims for this example: the pgvector extension and its film_embedding table (the compose
-- PostgreSQL has no pgvector, and the drizzle module does not carry the table), and OWNER
-- statements are rewritten to the compose role at load time by the test.
--
