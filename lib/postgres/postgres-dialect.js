...
// drizzle-orm 1.0.0 reports a vector's dimensions as 0 and moves the declared size to length.
const declaredDimensions = (column) => {
  const dimensions = column.dimensions || column.length;
