...
const largestValues = {
  SQLiteInteger: Number.MAX_SAFE_INTEGER,
  SQLiteBigInt: SQLITE_INTEGER_MAX,
};
...
const columnDetails = { [ColumnKind.Text]: boundedLength, [ColumnKind.Timestamp]: fractionalSeconds };
